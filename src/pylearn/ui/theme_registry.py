...
DARK = ThemePalette(
    ...
    h1="#cba6f7", h2="#89b4fa", h3="#74c7ec",
    code_bg="#181825", code_text="#cdd6f4", code_border="#45475a",
    note_bg="#1e1e2e", note_border="#89b4fa",
    ...
    syn_string="#fab387", syn_class="#89b4fa", syn_func="#89b4fa",
...
SEPIA = ThemePalette(
    ...
    border="#d4c5a9",
    accent="#8b6914", accent_hover="#7a5b10", accent_text="#faf6ee",
    h1="#6b3a2a", h2="#7a5230", h3="#8b6914",
