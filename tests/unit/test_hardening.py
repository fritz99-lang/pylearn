...
from pylearn.core.config import AppConfig, EditorConfig
...
from pylearn.executor.sandbox import _MAX_OUTPUT_CHARS, check_dangerous_code
...
class TestBookIdCollision:
    def test_collision_appends_suffix(self):
        ...
        mock_config.get_book.side_effect = lambda bid: {"book_id": bid} if bid == "test_book" else None
    ...
    def test_multiple_collisions(self):
        ...
        mock_config.get_book.side_effect = lambda bid: {"book_id": bid} if bid in existing else None
